...
3. Modify the desired attributes (text, position, color, etc.) while preserving fields you do not need to change
4. Write the updated JSON back to the file with stable formatting: 2-space indentation and a trailing newline
